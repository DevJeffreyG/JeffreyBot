...
const { ModifierType } = require('../../utils/Enums');
        ...
        autoroles: [
            {
                ...
                req_ids: [{ type: String, default: null }],
                req_all: {type: Boolean, default: false },
                emote: { type: String },
...
GuildSchema.method("addAutoRole", async function (name, role_id, req_ids, req_all, emoteInfo, id) {
    let emote = emoteInfo;
