        ...
        switch(objetivo.content){
            ...
            case "role":
                ...
                if(isSub){ // es una suscripción, preguntar el intervalo de los pagos
                    ...
                    toConfirm.push(`Es una **suscripción** de cada **${new HumanMs(duration).human}**.`);
                } else {
                    ...
                    if(isTemp){
                        ...
                        toConfirm.push(`Es un rol **temporal** que se quita al cabo de **${new HumanMs(duration).human}**.`);
                    }
                }
