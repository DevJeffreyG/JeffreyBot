            ...
            if(key){
                ...
                switch(reward.type){
                    ...
                    case "role":
                        ...
                        reply = `Se ha agregado el role \`${role.name}\` ${isTemp ? `por ${prettyms(reward.duration, {secondsDecimalDigits: 0 })}` : "permanentemente"}.`
                        break;
                    ...
                    case "boost":
                        ...
                        reply = `Se ha activado el boost ${reward.boost_type === "boostMultiplier" ? "multiplicador" : "de probabilidad"} x${reward.boost_value} por ${prettyms(reward.duration, {secondsDecimalDigits: 0 })}.`
                        break;
